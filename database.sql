BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE meal_plan CASCADE CONSTRAINTS PURGE';
EXCEPTION
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE meal CASCADE CONSTRAINTS PURGE';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -0942 THEN RAISE; END IF;
END; /
CREATE TABLE meal
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE recipe_instruction CASCADE CONSTRAINTS PURGE';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -0942 THEN RAISE; END IF;
END; /
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE food CASCADE CONSTRAINTS PURGE';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -0942 THEN RAISE; END IF;
END; /
CREATE TABLE food
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE recipe_ingredient CASCADE CONSTRAINTS PURGE';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -0942 THEN RAISE; END IF;
END; /
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE fridge_item CASCADE CONSTRAINTS PURGE';
EXCEPTION
    WHEN OTHERS THEN IF SQLCODE != -0942 THEN RAISE; END IF;
END; /
